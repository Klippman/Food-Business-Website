    ...
    <body>
        ...
        <section class="section-features js--section-features" id="features">
            ...
            <div class="row js--wp-1">
                <div class="col span-1-of-4 box">
                    <i class="ion-ios-infinite-outline icons"></i>
                    <h3>Up to 365 days/year</h3>
                    <p>Never cook again! We really mean that. Our subscription plans include up to 365 days/year coverage. You can also choose to order more flexibly if that's your style.</p>
                </div>
                <div class="col span-1-of-4 box">
                    <i class="ion-ios-stopwatch-outline icons"></i>
                    <h3>Ready in 20 minutes</h3>
                    <p>You're only twenty minutes away from your delicious and super healthy meals delivered right to your home. We work with the best chefs in each town to ensure that you're 100% happy.</p>
                </div>
                <div class="col span-1-of-4 box">
                    <i class="ion-ios-nutrition-outline icons"></i>
                    <h3>100% organic</h3>
                    <p>All our vegetables are fresh, organic and local. Animals are raised without added hormones or antibiotics. Good for your health, the environment, and it also tastes better!</p>
                </div>
                <div class="col span-1-of-4 box">
                    <i class="ion-ios-cart-outline icons"></i>
        ...
        <section class="section-cities" id="cities">
                ...
                <div class="row js--wp-3">
                    <div class="col span-1-of-4 box">
                        <img src="resources/img/lisbon-3.jpg" alt="Lisbon Photo" class="city-pic">
                        <h3>Lisbon</h3>
                        <div class="city-feature">
                            <i class="ion-android-person icons-small"></i>
                            1600+ happy eaters
                        </div>
                        <div class="city-feature">
                    ...
                    <div class="col span-1-of-4 box">
                        <img src="resources/img/san-francisco.jpg" alt="San Francisco Photo" class="city-pic">
                        <h3>San Francisco</h3>
                        <div class="city-feature">
                            <i class="ion-android-person icons-small"></i>
                            3700+ happy eaters
                    ...
                    <div class="col span-1-of-4 box">
                        <img src="resources/img/berlin.jpg" alt="Berlin Photo" class="city-pic">
                        <h3>Berlin</h3>
                        <div class="city-feature">
                            <i class="ion-android-person icons-small"></i>
                            2300+ happy eaters
                    ...
                    <div class="col span-1-of-4 box">
                        <img src="resources/img/london.jpg" alt="London Photo" class="city-pic">
                        <h3>London</h3>
                        <div class="city-feature">
                            <i class="ion-android-person icons-small"></i>
                            1200+ happy eaters
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    <div class="plan-box js--wp-4">
                        ...
                        <div>
                            <ul>
                                <li><i class="ion-checkmark icons-small"></i>1 meal every day</li>
                                <li><i class="ion-checkmark icons-small"></i>Order 24/7</li>
                                <li><i class="ion-checkmark icons-small"></i>Access to newest creations</li>
                                <li><i class="ion-checkmark icons-small"></i>Free delivery</li>
                            </ul>
                        </div>
                        <div>
                ...
                <div class="col span-1-of-3">
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                <li><i class="ion-checkmark icons-small"></i>1 meal 10 days/month</li>
                                <li><i class="ion-checkmark icons-small"></i>Order 24/7</li>
                                <li><i class="ion-checkmark icons-small"></i>Access to newest creations</li>
                                <li><i class="ion-checkmark icons-small"></i>Free delivery</li>
                            </ul>
                ...
                <div class="col span-1-of-3">
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                <li><i class="ion-checkmark icons-small"></i>1 meal</li>
                                <li><i class="ion-checkmark icons-small"></i>Order from 8 am to 12 pm</li>
                                <li><i class="ion-close icons-small"></i></li>
                                <li><i class="ion-checkmark icons-small"></i>Free delivery</li>
                            </ul>
                        </div>
                        <div>
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2">
                    <ul class="social-links">
                        <li><a href="#"><i class="ion-social-facebook facebook"></i></a></li>
                        <li><a href="#"><i class="ion-social-twitter twitter"></i></a></li>
                        <li><a href="#"><i class="ion-social-googleplus googleplus"></i></a></li>
                        <li><a href="#"><i class="ion-social-instagram instagram"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="row">
                <p>
                    Copyright &copy; 2019 Ominfood. All rights reserved.
                </p>
            </div>
        </footer>
